          ...
          <div className={styles.aiGrid}>
            <article className={styles.aiCard}>
              <div className={styles.aiImg}>
                <img src="/img/ai/ai-concepts.jpg" alt="Генерация концепций ИИ" loading="lazy"/>
              </div>
            ...
            <article className={styles.aiCard}>
              <div className={styles.aiImg}>
                <img src="/img/ai/ai-generative.jpg" alt="Генеративный дизайн" loading="lazy"/>
              </div>
            ...
            <article className={styles.aiCard}>
              <div className={styles.aiImg}>
                <img src="/img/ai/ai-modeling.jpg" alt="Автоматизация 3D‑моделирования" loading="lazy"/>
              </div>
            ...
            <article className={styles.aiCard}>
              <div className={styles.aiImg}>
                <img src="/img/ai/ai-optimization.jpg" alt="Оптимизация форм и параметров" loading="lazy"/>
              </div>
