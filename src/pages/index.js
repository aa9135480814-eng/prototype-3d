...
export default function Home() {
  ...
  Рассчитать проект
                ...
                <a href="#portfolio" className={styles.btnGhost}>Портфолио</a>
              </div>
            </div>

            {/* иллюстрация справа — можешь заменить на 3D/рендер */}
            <div className={styles.heroArt}>
              <img src="/img/hero-plant.jpg" alt="Футуристичная сцена" />
            </div>
          </div>
          ...
          <div className={styles.cardGrid}>
            <article className={styles.card}>
              <div className={styles.cardMedia}>
                <img src="/img/grid-lab.jpg" alt="Лаборатория" />
              </div>
              <h4>Инжиниринг</h4>
            ...
            <article className={styles.card}>
              <div className={styles.cardMedia}>
                <img src="/img/grid-laser.jpg" alt="DLP/SLA" />
              </div>
              <h4>DLP, SLS и FDM</h4>
            ...
            <article className={styles.card}>
              <div className={styles.cardMedia}>
                <img src="/img/grid-space.jpg" alt="Постобработка" />
              </div>
              <h4>Постобработка</h4>
  ...
  <div className={styles.footerNeoGrid}>
    ...
    <div className={styles.card + ' ' + styles.cardCTA}>
      ...
      <div className={styles.btnRow}>
        <a className={styles.btnGlow} href="#meet">Записаться на встречу</a>
      </div>
    </div>
