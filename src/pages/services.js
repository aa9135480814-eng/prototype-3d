        ...
        <section className={styles.grid}>
          ...
          <article className={styles.card}>
            <div className={styles.thumb}>
              <img src="/prototype-3d/img/services/scanning.jpg" alt="3D‑сканирование" />
            </div>
          ...
          <article className={styles.card}>
            <div className={styles.thumb}>
              <img src="/prototype-3d/img/services/modeling.jpg" alt="3D‑моделирование" />
            </div>
          ...
          <article className={styles.card}>
            <div className={styles.thumb}>
              <img src="/prototype-3d/img/services/printing.jpg" alt="Серийная 3D‑печать" />
            </div>
          ...
          <article className={styles.card}>
            <div className={styles.thumb}>
              <img src="/prototype-3d/img/services/postproc.jpg" alt="Постобработка" />
            </div>
            <h3>Постобработка</h3>
          ...
          <article className={styles.card}>
            <div className={styles.thumb}>
              <img src="/prototype-3d/img/services/software.jpg" alt="Разработка ПО" />
            </div>
            <h3>Разработка ПО</h3>
          ...
          <article className={styles.card}>
            <div className={styles.thumb}>
              <img src="/prototype-3d/img/services/optimize.jpg" alt="Оптимизация производства" />
            </div>
          ...
          <article className={styles.card}>
            <div className={styles.thumb}>
              <img src="/prototype-3d/img/services/pcb.jpg" alt="Производство плат" />
            </div>
          ...
          <article className={styles.card}>
            <div className={styles.thumb}>
              <img src="/prototype-3d/img/services/electro.jpg" alt="Электромех. изделия и робототехника" />
            </div>
